...
n
  constructor(private doc: DoctorService, private fb: FormBuilder) {
    this.docService = doc; // Assigning the DoctorService instance
  }
t
  ngOnInit(): void {
    // Initializing the AddDoctorForm with form controls
    this.AddDoctorForm = this.fb.group({
      DoctorName: ['', [Validators.required]] // DoctorName form control with required validator
    });
  }
